...
class MenuPrincipalPage extends GetView<MenuPrincipalController> {
                  ...
                  child:   Column(children: [
                    Row(
                      ...
                      children: [
                        ...
                        imgPerfilRedonda(
                          size: 18,
                          img: controller.listaModulo[ind].imgBase64==''?null:controller.listaModulo[ind].imgBase64,
                        ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ...
                                controller.listaModulo[ind].tituloModulo.toUpperCase(),
                                style: TextStyle(
              ...
              Container(
                ...
                Obx(() => controller.userPref!=''?    Text(
                  ...
                  style: TextStyle(
                    ...
                    Container(
                      color: Colors.white,
                      child: Text( 'Hoy es ${UtilidadesUtil.getFechaActual}',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 10,
  ...
  Widget btnR() {
    ...
    Container(
    padding: EdgeInsets.symmetric(vertical: 25.0,horizontal: 50),child: Text('La Conexión a Internet esta restablecida favor Cargue los Módulos de Mi Upc',  style: TextStyle(
        fontWeight:
        FontWeight.bold,
        fontSize: 18,
        color: Colors.black,
